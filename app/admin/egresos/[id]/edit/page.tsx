...
export default async function EditExpensePage({
  ...
  const expService = createExpensesService(supabase)
  ...
  return (
    <div className="container mx-auto p-6 space-y-6 max-w-3xl">
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-3xl font-bold">Editar Egreso</h1>
      </div>
      <ExpenseForm expense={expense} categories={categories} suppliers={suppliers} />
    </div>
  )
}
